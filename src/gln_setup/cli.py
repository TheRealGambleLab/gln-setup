...
def gln_install(
    ...
    try:
        run(    
            cmd + [f"git+ssh://{username}@{username}.hpc.einsteinmed.edu/gs/gsfs0/users/Gamble%20Lab/ria/gamblelab/27b/f579f-abbb-44c7-9df2-f7af88306267#egg=gln[extensions]"],
            check = True,
        )
